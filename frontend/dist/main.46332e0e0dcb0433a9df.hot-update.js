...
function UnderStandModal({
  ...
  const onSubmit = (e, response) => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(`/lecture/${lectureId}/lesson/${lessonId}/live/understanding/${understandId}/professor`, {
      response: 0
    }, {
      params: {
        session: `${sessionId}`
...
//# sourceMappingURL=main.46332e0e0dcb0433a9df.hot-update.js.map
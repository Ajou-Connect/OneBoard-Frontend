...
const VideoContainer = props => {
  ...
  const checkUnderstand = () => {
    axios__WEBPACK_IMPORTED_MODULE_15___default.a.get(`/lecture/${lectureId}/lesson/${lessonId}/live/understanding/professor`, {
      ...
      const result = res.data.data.understandId;
      console.log(result);
...
_s(VideoContainer, "8W6jHUdejrIwVr/lV5nJq8/2r18=", false, function () {
...
//# sourceMappingURL=main.8709224c4d9b3db6f67a.hot-update.js.map
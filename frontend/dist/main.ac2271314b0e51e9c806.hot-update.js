...
const VideoContainer = props => {
  ...
  const checkUnderstand = () => {
    axios__WEBPACK_IMPORTED_MODULE_15___default.a.get(`/lecture/${lectureId}/lesson/${lessonId}/live/understanding/${pfUnderStandId}/professor`).then(res => {
      console.log(res);
    }).catch(error => {
      console.log(error);
    });
...
//# sourceMappingURL=main.ac2271314b0e51e9c806.hot-update.js.map
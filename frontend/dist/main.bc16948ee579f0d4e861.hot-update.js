...
function UnderStandModal({
  ...
  const onSubmit = (e, response) => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(`/lecture/${lectureId}/lesson/${lessonId}/live/understanding/professor`, {
      response: 0
    }, {
      params: {
        session: `${sessionId}`
...
//# sourceMappingURL=main.bc16948ee579f0d4e861.hot-update.js.map
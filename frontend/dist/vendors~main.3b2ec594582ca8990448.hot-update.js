...
const eventListenerOptions = _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["I"] ? {
  passive: true
} : false;
...
function fromNativeEvent(event, chart) {
  ...
  const {
    x,
    y
  } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["y"])(event, chart);
  return {
    type,
    chart,
    native: event,
...
function registerDefaults(item, scope, parentScope) {
  const itemDefaults = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["a1"])(Object.create(null), [parentScope ? _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["d"].get(parentScope) : {}, _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["d"].get(scope), item.defaults]);
...
function mergeScaleConfig(config, options) {
  const chartDefaults = _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["a0"][config.type] || {
    scales: {}
  };
...
const hasFunction = value => Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["i"])(value) && Object.getOwnPropertyNames(value).reduce((acc, key) => acc || Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["a4"])(value[key]), false);

function needContext(proxy, names) {
  const {
    isScriptable,
    isIndexable
  } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["a7"])(proxy);
...
class ArcElement extends Element {
  ...
  inRange(chartX, chartY, useFinalPosition) {
    ...
    const {
      angle,
      distance
    } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["af"])(point, {
      x: chartX,
      y: chartY
    });
    const {
...
class LineElement extends Element {
  ...
  interpolate(point, property) {
    ...
    const segments = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ak"])(this, {
      property,
      start: value,
      end: value
    });
...
function getBackgroundPoint(options, size, alignment, chart) {
  ...
  const {
    ...
    bottomLeft,
    bottomRight
  } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(cornerRadius);
...
class Tooltip extends Element {
  ...
  drawBackground(pt, ctx, tooltipSize, options) {
    ...
    const {
      ...
      bottomLeft,
      bottomRight
    } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(options.cornerRadius);
    ctx.fillStyle = options.backgroundColor;
    ctx.strokeStyle = options.borderColor;
    ctx.lineWidth = options.borderWidth;
    ctx.beginPath();
...
function generateTicks$1(generationOptions, dataRange) {
  ...
  const decimalPlaces = Math.max(Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aG"])(spacing), Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aG"])(niceMin));
...
function addTick(ticks, time, timestamps) {
  if (!timestamps) {
    ...
    const {
      lo,
      hi
    } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aJ"])(timestamps, time);
  ...
  if (reverse) {
    if (val >= table[lo].pos && val <= table[hi].pos) {
      ({
        lo,
        hi
      } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["x"])(table, 'pos', val));
    }
    ...
    if (val >= table[lo].time && val <= table[hi].time) {
      ({
        lo,
        hi
      } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["x"])(table, 'time', val));
    }
...
//# sourceMappingURL=vendors~main.3b2ec594582ca8990448.hot-update.js.map